...
public class MenuBarPanel extends Panel implements IStyleResolver {
	...
	private static final SimpleAttributeModifier idSingleMenu = new SimpleAttributeModifier("class", "singleMenu");
	private static final SimpleAttributeModifier idFirstMenu = new SimpleAttributeModifier("class", "firstMenu");

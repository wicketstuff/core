...
import org.wicketstuff.jwicket.tooltip.res.walterzorn.Anchor;
	...
	IHeaderContributor getHeadercontributor() {
		return new IHeaderContributor() {
			...
			public void renderHead(final IHeaderResponse response) {
				...
				response.renderJavascriptReference(new JavascriptResourceReference(Anchor.class, "walterzorn_tip.js"));

 ...
 */
public class GenericDroppableBehavior<T> extends AbstractDragDropBehavior {
	...
	public GenericDroppableBehavior() {
	 ...
	 * @return this object
	 */
	public GenericDroppableBehavior<T> setWantOnActivatedNotification(final boolean value) {
	 ...
	 * @return this object
	 */
	public GenericDroppableBehavior<T> setWantOnDeactivateNotification(final boolean value) {
	 ...
	 * @return this object
	 */
	public GenericDroppableBehavior<T> setDraggablesAcceptedByDroppable(final DraggablesAcceptedByDroppable accepted) {
	 ...
	 * @return this object
	 */
	public GenericDroppableBehavior<T> setActiveClass(final String activeClass) {
		if (activeClass == null)
	...
	public GenericDroppableBehavior<T> setActiveClass(final AjaxRequestTarget target, final String activeClass) {
	 ...
	 * @return this object
	 */
	public GenericDroppableBehavior<T> setAddClasses(final boolean value) {
		if (value)
	...
	public GenericDroppableBehavior<T> setAddClasses(final AjaxRequestTarget target, final boolean value) {
		setAddClasses(value);
	 ...
	 * @return this object
	 */
	public GenericDroppableBehavior<T> setGreedy(final boolean value) {
		if (value)
	...
	public GenericDroppableBehavior<T> setGreedy(final AjaxRequestTarget target, final boolean value) {
		setGreedy(value);
	 ...
	 * @return this object
	 */
	public GenericDroppableBehavior<T> setHoverClass(final String hoverClass) {
		if (hoverClass == null)
	...
	public GenericDroppableBehavior<T> setHoverClass(final AjaxRequestTarget target, final String hoverClass) {
	 ...
	 * @return this object
	 */
	public GenericDroppableBehavior<T> setScope(final String scope) {
		if (scope == null)
	...
	public GenericDroppableBehavior<T> setScope(final AjaxRequestTarget target, final String scope) {
		setScope(scope);
		if (scope != null)
	 ...
	 * @return this object
	 */
	public GenericDroppableBehavior<T> setTolerance(final DropTolerance tolerance) {
		if (tolerance == null)
	...
	public GenericDroppableBehavior<T> setScope(final AjaxRequestTarget target, final DropTolerance tolerance) {
...
System.out.println("EventType = " + dragEventType);
			...
			if (component instanceof IGenericDroppable<?>) {
				IGenericDroppable<T> draggableComponent = (IGenericDroppable<T>)component;
				if (dragEventType == EventType.DROP)
					draggableComponent.onDrop(target, (T)visitor.getFoundComponent());
				else if (dragEventType == EventType.DROP_ACTIVATE)
					draggableComponent.onActivate(target, (T)visitor.getFoundComponent());
				else if (dragEventType == EventType.DROP_DEACTIVATE)
					draggableComponent.onDeactivate(target, (T)visitor.getFoundComponent());
			}
else
System.out.println("!!Die gedroppte Componenet: " + component.getClass().getName());

...
public class DraggableBehavior extends AbstractDragDropBehavior {
	...
	public DraggableBehavior() {
		super(new JavascriptResourceReference(DraggableBehavior.class, "ui.draggable.js"));
	}
...
System.out.println("---------- Draggable.respond: " + dragEventType);
			...
			System.out.println("---------- Draggable.respond: ???");
	}

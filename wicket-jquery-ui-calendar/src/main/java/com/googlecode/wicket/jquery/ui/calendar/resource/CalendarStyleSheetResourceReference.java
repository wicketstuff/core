...
/**
 * Provides the resource reference for the fullcalendar stylesheet library.<br/>
...
public class CalendarStyleSheetResourceReference extends CssResourceReference
{
	...
	private static final CalendarStyleSheetResourceReference INSTANCE = new CalendarStyleSheetResourceReference();
	 ...
	 */
	public static CalendarStyleSheetResourceReference get()
	{
		return INSTANCE;
	}
	 ...
	 * Private constructor
	 */
	private CalendarStyleSheetResourceReference()
	{
		super(CalendarStyleSheetResourceReference.class, "fullcalendar.css");
	}
}

...
SimileAjax.Graphics.createBubbleForContentAndPoint=function(E,D,B,A,C){if(typeof A!="number"){A=300;
}E.style.position="absolute";
E.style.left="-5000px";
E.style.top="0px";
E.style.width=A+"px";
document.body.appendChild(E);
window.setTimeout(function(){var F=E.scrollWidth+10;
var H=E.scrollHeight+10;
var G=SimileAjax.Graphics.createBubbleForPoint(D,B,F,H,C);
...
SimileAjax.Graphics.createBubbleForPoint=function(B,A,M,Q,H){function S(){if(typeof window.innerHeight=="number"){return{w:window.innerWidth,h:window.innerHeight};
...
}}}}var L=function(){if(!W._closed){document.body.removeChild(W._div);
W._doc=null;
W._div=null;
W._content=null;
W._closed=true;
...
var E=O.w;
var F=O.h;
var C=SimileAjax.Graphics._bubbleMargins;
M=parseInt(M,10);
Q=parseInt(Q,10);
var N=C.left+M+C.right;
var T=C.top+Q+C.bottom;
var R=SimileAjax.Graphics.pngIsTranslucent;
var D=SimileAjax.urlPrefix;
var J=function(Y,X,Z,a){Y.style.position="absolute";
Y.style.width=Z+"px";
Y.style.height=a+"px";
if(R){Y.style.background="url("+X+")";
}else{Y.style.filter="progid:DXImageTransform.Microsoft.AlphaImageLoader(src='"+X+"', sizingMethod='crop')";
}};
...
K.style.zIndex=1000;
var V=SimileAjax.WindowManager.pushLayer(L,true,K);
W._div=K;
W.close=function(){SimileAjax.WindowManager.popLayer(V);
};
...
K.appendChild(G);
var P=function(X,c,b,Y,a){var Z=document.createElement("div");
Z.style.left=c+"px";
Z.style.top=b+"px";
J(Z,X,Y,a);
G.appendChild(Z);
};
P(D+"images/bubble-top-left.png",0,0,C.left,C.top);
P(D+"images/bubble-top.png",C.left,0,M,C.top);
P(D+"images/bubble-top-right.png",C.left+M,0,C.right,C.top);
P(D+"images/bubble-left.png",0,C.top,C.left,Q);
P(D+"images/bubble-right.png",C.left+M,C.top,C.right,Q);
P(D+"images/bubble-bottom-left.png",0,C.top+Q,C.left,C.bottom);
P(D+"images/bubble-bottom.png",C.left,C.top+Q,M,C.bottom);
P(D+"images/bubble-bottom-right.png",C.left+M,C.top+Q,C.right,C.bottom);
var U=document.createElement("div");
U.style.left=(N-C.right+SimileAjax.Graphics._bubblePadding-16-2)+"px";
U.style.top=(C.top-SimileAjax.Graphics._bubblePadding+1)+"px";
U.style.cursor="pointer";
J(U,D+"images/close-button.png",16,16);
SimileAjax.WindowManager.registerEventWithObject(U,"click",W,"close");
G.appendChild(U);
...
G.appendChild(I);
W.content=I;
(function(){if(B-SimileAjax.Graphics._halfArrowWidth-SimileAjax.Graphics._bubblePadding>0&&B+SimileAjax.Graphics._halfArrowWidth+SimileAjax.Graphics._bubblePadding<E){var Z=B-Math.round(M/2)-C.left;
Z=B<(E/2)?Math.max(Z,-(C.left-SimileAjax.Graphics._bubblePadding)):Math.min(Z,E+(C.right-SimileAjax.Graphics._bubblePadding)-N);
if((H&&H=="top")||(!H&&(A-SimileAjax.Graphics._bubblePointOffset-T>0))){var X=document.createElement("div");
X.style.left=(B-SimileAjax.Graphics._halfArrowWidth-Z)+"px";
X.style.top=(C.top+Q)+"px";
J(X,D+"images/bubble-bottom-arrow.png",37,C.bottom);
G.appendChild(X);
K.style.left=Z+"px";
K.style.top=(A-SimileAjax.Graphics._bubblePointOffset-T+SimileAjax.Graphics._arrowOffsets.bottom)+"px";
return ;
}else{if((H&&H=="bottom")||(!H&&(A+SimileAjax.Graphics._bubblePointOffset+T<F))){var X=document.createElement("div");
X.style.left=(B-SimileAjax.Graphics._halfArrowWidth-Z)+"px";
X.style.top="0px";
J(X,D+"images/bubble-top-arrow.png",37,C.top);
G.appendChild(X);
K.style.left=Z+"px";
K.style.top=(A+SimileAjax.Graphics._bubblePointOffset-SimileAjax.Graphics._arrowOffsets.top)+"px";
return ;
}}}var Y=A-Math.round(Q/2)-C.top;
Y=A<(F/2)?Math.max(Y,-(C.top-SimileAjax.Graphics._bubblePadding)):Math.min(Y,F+(C.bottom-SimileAjax.Graphics._bubblePadding)-T);
if((H&&H=="left")||(!H&&(B-SimileAjax.Graphics._bubblePointOffset-N>0))){var X=document.createElement("div");
X.style.left=(C.left+M)+"px";
X.style.top=(A-SimileAjax.Graphics._halfArrowWidth-Y)+"px";
J(X,D+"images/bubble-right-arrow.png",C.right,37);
G.appendChild(X);
K.style.left=(B-SimileAjax.Graphics._bubblePointOffset-N+SimileAjax.Graphics._arrowOffsets.right)+"px";
K.style.top=Y+"px";
}else{if((H&&H=="right")||(!H&&(B-SimileAjax.Graphics._bubblePointOffset-N<E))){var X=document.createElement("div");
X.style.left="0px";
X.style.top=(A-SimileAjax.Graphics._halfArrowWidth-Y)+"px";
J(X,D+"images/bubble-left-arrow.png",C.left,37);
G.appendChild(X);
K.style.left=(B+SimileAjax.Graphics._bubblePointOffset-SimileAjax.Graphics._arrowOffsets.left)+"px";
K.style.top=Y+"px";
}}})();

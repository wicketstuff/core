...
/**
 * See "click" in the event section of <a href="http://www.google.com/apis/maps/documentation/reference.html#GMap2"
 * >GMap2</a>.
 */
public abstract class ClickListener extends GEventListenerBehavior
{
	...
	protected void onEvent(AjaxRequestTarget target)
	{
		...
		{
			for (GOverlay ovl : getGMap().getOverlays())
			{
	 ...
	 * "http://www.google.com/apis/maps/documentation/reference.html#GMap2" >GMap2</a>.
	 * 
	 * @param latLng

...
public class DojoPackagedTextTemplate extends PackagedTextTemplate {
	 ...
	 */
	public DojoPackagedTextTemplate(final Class<?> clazz,
	 ...
	 * for all widget of the same class</b>. So if there are n widget on the
	 * same page, a resource rendered with a StaticKey will be displayed once.
	 * 

...
/**
 * Same as WicketJSPUrl but for JSF
 * 
 * @see wicket.jsp.taglib.WicketJSPURL
 * 
 * @author Tobias Soloschenko
 */
public final class WicketJSFURL extends TagHandler {
     ...
     */
    public WicketJSFURL(TagConfig config) {
	super(config);

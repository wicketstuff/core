...
/**
 * An extension of {@link KryoReflectionFactorySupport} that logs the serialized
 * objects and the current size of the buffer after the write.
 * Additionally provides the functionality to blacklist the serialization
 * of specific classes.
 */
public class DebuggingKryo extends KryoReflectionFactorySupport {
    ...
    public DebuggingKryo() {
        this.blackList = new ArrayList<Class<?>>();
    }

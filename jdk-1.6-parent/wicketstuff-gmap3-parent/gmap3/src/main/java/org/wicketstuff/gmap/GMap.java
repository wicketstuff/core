...
public class GMap extends Panel implements GOverlayContainer {
	...
	protected void onBeforeRender() {
		...
		if (getApplication().usesDevelopmentConfig() && !getApplication().getMarkupSettings().getStripWicketTags()) {
	...
	public void update() {
		...
		final String requestMapType = requestParameters.getParameterValue("currentMapType").toString();
		mapType =
		        requestMapType != null ? GMapType.valueOf(requestParameters.getParameterValue("currentMapType")
		                .toString()) : mapType;
	}

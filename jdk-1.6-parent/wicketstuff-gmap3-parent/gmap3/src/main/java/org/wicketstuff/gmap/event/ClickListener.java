 ...
 * href="https://developers.google.com/maps/documentation/javascript/reference#Map">Map</a>.
 */
public abstract class ClickListener extends GEventListenerBehavior {
	...
	protected void onEvent(final AjaxRequestTarget target) {
		...
		final NumberFormat fmt = DecimalFormat.getInstance(Locale.US);
		GLatLng latLng = null;

		final String latStr = request.getRequestParameters().getParameterValue("lat").toString();
		final String lngStr = request.getRequestParameters().getParameterValue("lng").toString();
		Double lat = null;
		Double lng = null;
		try {

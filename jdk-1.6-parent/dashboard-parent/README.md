...
Features/Benefits
-------------------
With wicketstuff-dasboard you can easily add a dashboard with standard and custom widgets to your wicket application.  
...
the jquery internal version, or to specify another versions for wicketstuff-dashboard's resources.
    ...
    public void init() {
        ...
        // I don't want to add the internal wicketstuff-dashboard's jquery to page head when I used DashboardPanel

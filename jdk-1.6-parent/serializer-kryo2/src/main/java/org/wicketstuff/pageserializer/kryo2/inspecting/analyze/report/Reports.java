...
public class Reports
{
	...
	public static void label(StringBuilder sb, Ident ident, String label, int columnSize,
		char filler)
	{
	...
	public static void rightColumn(StringBuilder sb, int columnSize, char filler, String value,
		char overflow)
	{
		if (value != null)
		{

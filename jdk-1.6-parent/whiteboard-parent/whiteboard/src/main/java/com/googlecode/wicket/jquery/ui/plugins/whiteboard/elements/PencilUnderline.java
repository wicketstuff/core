...
public class PencilUnderline extends Element{
	...
	public PencilUnderline(int id, String label, String color, Boolean hidden, String type, Boolean trace, int p1, int p2, int thick){
		this.id=id;
		this.label=label;
		this.color=color;
		this.hidden=hidden;
	...
	public PencilUnderline(JSONObject object) throws JSONException{
		...
		this.thick=(Integer)object.get("thick");

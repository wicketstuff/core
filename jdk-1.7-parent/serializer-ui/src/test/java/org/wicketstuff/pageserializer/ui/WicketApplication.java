/**
 * Copyright (C)
 * 	2014 Michael Mosmann <michael@mosmann.de>
 *
...
public class WicketApplication extends WebApplication
{
	...
	public void init()
	{
		...
		ui = SerializerUIStarter.startUI();
		...
		ISerializedObjectTreeProcessor treeProcessor = TreeProcessors.listOf(ui.treeProcessor(), new TypeSizeReport(reportOutput.with(Keys.withNameAndFileExtension("TypeSizeReport", "txt"))),

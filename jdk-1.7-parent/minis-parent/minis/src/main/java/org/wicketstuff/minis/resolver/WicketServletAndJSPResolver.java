...
public class WicketServletAndJSPResolver implements IComponentResolver {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(WicketServletAndJSPResolver.class);
	...
	private static class JSPIncludeHttpServletResponseWrapper extends HttpServletResponseWrapper {
		...
		private final ServletOutputStream byteArrayServletOutputStream = new ByteArrayServletOutputStream(byteArrayOutputStream);
		...
		public String getOutput() throws UnsupportedEncodingException {
			// if something has been written with the writer - we need to flush it!
			printWriter.flush();

...
public class Select2MultiChoiceTest extends Assert
{
	...
	{
		List<String> strings = Select2MultiChoice.splitInput("{\"email\":{\"emailAddress\":\"nouser@test.com\"},\"isContact\":true},{\"email\":{\"emailAddress\":\"otheruser@test.com\"},\"isContact\":contact}");
		assertEquals(2, strings.size());
	}
}

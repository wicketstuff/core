...
public abstract class CometdAbstractBehavior extends AbstractRequireDojoBehavior
{
	...
	private static final ResourceReference JS = new ResourceReference(CometdAbstractBehavior.class, "wicket-cometd.js");
	...
	{
		return getComponent().getMarkupId()+"@"+getChannelId();
	}
	 ...
	 * </p>
	 * 
	 * @return cometd interceptor script
	 */
	 ...
	 * DojoPackagesTextTemplate such as <code>'MyFunction'</code> or an objectInstance and one of
	 * its function, i.e, <code>'MyObject','OneFunctionOfMyObject'</code>
	 * </p>
	 * 
	 ...
	 * subscribe comes from getChannelId method, Merthod or object to invoke
	 * when a event is triggered on client side is given by

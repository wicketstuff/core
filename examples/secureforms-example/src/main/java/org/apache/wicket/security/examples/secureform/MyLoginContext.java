...
/**
 * MyLoginContext gives a succesfull authentication when the username is the same as the password
 * By default all succesfull logged on users receive the 'user' principal.
 * When you login with admin/admin, you'll get the admin principal too.
 *

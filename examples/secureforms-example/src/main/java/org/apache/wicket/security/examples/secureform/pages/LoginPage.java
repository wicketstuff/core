...
public class LoginPage extends WebPage
{
	...
	public LoginPage()
	{
        ...
        add(new SignInForm("signInForm")
        {
            public boolean signIn(String username, String password) {
                ...
                MyLoginContext loggedInUser = new MyLoginContext(username, password);

				try
				{
				    secureSession.login(loggedInUser);
    ...
    public abstract class SignInForm extends StatelessForm
    {
        ...
        /**
         * Implement this method in your extension class in order to actually login a user.
         *
         * @param username
         * @param password

...
/**
 * Abstract base page for testing wicket pages based on the ACEGI security setup.
 * This base creates the WicketTester as a mock, usable by the testpages that extend this page.
 * <p/>
...
public abstract class AbstractSecureTestPage extends TestCase {
    protected static final Log log = LogFactory.getLog(AbstractSecureTestPage.class);
    /**
    ...
    /**
     * Convenience method to login to the application, mostly required as the whole is protected by ACEGI and Swarm
     * The test structure makes us of the ACEGI TestingAuthentication provider, meaning that you can pass on any
     * username (the password is the same).
     * <p/>
     * The user 'medical' has an additional role 'ROLE_MEDICAL'. All other users have 'ROLE_USER'
     *
     * @param userName
     */

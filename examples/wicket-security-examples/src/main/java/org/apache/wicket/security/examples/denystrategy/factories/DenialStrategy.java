...
/**
 * This is a very simple attempt to turn all permissions in a policy file into
 * denials. meaning if the policy says permission ${ComponentPermission}
 * "org.apache.wicket.security.examples.tabs.pages.MasterPage", "inherit,
 * render"; it means you are not allowed to render that page. This example is
 * not an attempt to show you how to turn swarm 180 degrees around but rather to
 * show you how to install a custom strategy.
 * 
 * @author marrink
 */
public class DenialStrategy extends SwarmStrategy
{
	 ...
	 * @param hiveQueen
	 */
	public DenialStrategy(Class secureClass, Object hiveQueen)
	{
		super(secureClass, hiveQueen);
	}

	/*
	 * Rather then changing all securitychecks we simply invert there return
	 * value. Note that this is probably not a good idea if you want to build
	 * your own denial strategy but for this example it will do.
	 * 
	 */

 ...
 * @author Chris Turner
 */
public class SwarmMockHttpServletRequest implements HttpServletRequest
{
	/**
	...
	/** Logging object */
	private static final Logger log = LoggerFactory.getLogger(SwarmMockHttpServletRequest.class);
	...
	private final SwarmMockHttpSession session;
	 ...
	 */
	public SwarmMockHttpServletRequest(final Application application,
			final SwarmMockHttpSession session, final ServletContext context)
	{
	...
	public void setRequestToRedirectString(final String redirect)
	{
		...
		// We need to absolutize the redirect URL as we are not as smart as a
		// web-browser
		// (WICKET-702)

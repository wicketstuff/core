 ...
 *
 */
public abstract class SecuredButton extends Button implements IIndicatingButton
{
	 ...
	 * {@inheritDoc}<br>
	 * <br>
	 * <b>Warning:</b> This is effective only when used with a {@link AjaxIndicatingButtonBehavior}.
	 */
	@Override

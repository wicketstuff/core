...
public class SillyRealm extends AuthorizingRealm
{
	 ...
	 * other credentials) in this method. The {@link org.jsecurity.realm.AuthenticatingRealm
	 * AuthenticatingRealm} superclass will do that automatically via the use of a configured
	 * {@link org.jsecurity.authc.credential.CredentialsMatcher CredentialsMatcher} (see this
	 * example's corresponding <code>jsecurity.ini</code> file to see a configured credentials
	 * matcher).
	 * <p/>

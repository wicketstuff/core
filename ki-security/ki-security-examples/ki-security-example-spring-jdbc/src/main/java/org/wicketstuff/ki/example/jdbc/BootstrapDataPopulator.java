 ...
 * under the License.
 */
package org.wicketstuff.ki.example.jdbc;
 ...
 * JSecurity Spring sample application to demonstrate the use of the
 * {@link org.jsecurity.realm.jdbc.JdbcRealm} The tables created by this class follow the default
 * table and column names that {@link org.jsecurity.realm.jdbc.JdbcRealm} uses.
 * 

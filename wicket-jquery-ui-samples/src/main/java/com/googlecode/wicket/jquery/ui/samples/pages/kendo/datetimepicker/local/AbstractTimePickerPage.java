...
abstract class AbstractTimePickerPage extends SamplePage
{
	...
	protected List<DemoLink> getDemoLinks()
	{
		return Arrays.asList(
				new DemoLink(LocalDatePickerPage.class, "DatePicker"),
				...
				new DemoLink(LocalTimePickerPage.class, "TimePicker"),
				...
				new DemoLink(LocalDateTimePickerPage.class, "DateTimePicker"),

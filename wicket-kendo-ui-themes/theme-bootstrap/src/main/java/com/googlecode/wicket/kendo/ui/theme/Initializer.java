...
public class Initializer implements IInitializer
{
	...
	public void init(Application application)
	{
		...
		settings.setKendoUIThemeStyleSheetReference(new CssResourceReference(Initializer.class, "kendo.bootstrap.min.css"));
	}
	...
	{
		return "Wicket extensions initializer (wicket-kendo-ui-theme-bootstrap)";
	}
}

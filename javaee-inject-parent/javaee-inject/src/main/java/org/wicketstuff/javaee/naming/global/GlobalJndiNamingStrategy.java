...
/**
 * Simple Java EE 6 Global JNDI naming support for java:global prefixed JNDI names
 * based on the EJB 3.1 specification Section 4.4.1, page 83
 * <br />
 ...
 * <br />
 * <p>
 * The <i>appName</i> only applies, if the application is packaged as an .ear file. It
 * defaults to the base name of the .ear file with no filename extension, unless
 * specified by the application.xml deployment descriptor.
 * </p>
 * <p>
 * The <i>moduleName</i> is the name of the module in which the session bean is packaged.
 * In a stand-alone ejb-jar file or .war file, the <i>moduleName</i> defaults to the
 * base name of the module with any filename extension removed. In an ear file,
 * the <i>moduleName</i> defaults to the pathname of the module with any filename
 * extension removed, but with any directory names included. The default <i>moduleName</i>
 * can be overriden using the module-name element of ejb-jar.xml (for ejb-jar
 * files) or web.xml (for .war files).
 * </p>
 *
 * @see <a href="http://jcp.org/aboutJava/communityprocess/final/jsr318/index.html">
 * EJB 3.1 specification</a>
 *
 * @author Peter Major
 */
public class GlobalJndiNamingStrategy implements IJndiNamingStrategy {
     ...
     * lookups.
     * 
     * @param appName The name of the application (defined in application.xml
     *                or name of the ear)
     * @param moduleName The name of the module (defined in ejb-jar.xml or name
     *                of the ejb-jar)
     */

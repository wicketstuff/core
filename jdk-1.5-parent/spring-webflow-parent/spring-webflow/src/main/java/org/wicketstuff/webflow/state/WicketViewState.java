...
/**
 * View State that includes attributes necessary for the display of a progress bar in page flow /panel flow
 * based application.
 *
 * @author Clint Checketts, Florian Braun, Doug Hall, Subramanian Murali
 * @version $Id: $
 */
public class WicketViewState extends ViewState implements IProgressBarState
{
	 ...
	 */
	public WicketViewState(Flow flow, String id, ViewFactory viewFactory, String progressText, int stepNumber) throws IllegalArgumentException
	{

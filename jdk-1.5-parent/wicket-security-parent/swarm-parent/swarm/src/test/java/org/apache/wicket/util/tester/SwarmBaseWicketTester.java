...
import org.apache.wicket.protocol.http.SwarmMockWebApplication;
 ...
 * @since 1.2.6
 */
public class SwarmBaseWicketTester extends SwarmMockWebApplication
{
	/** log. */
	private static final Logger log = LoggerFactory.getLogger(SwarmBaseWicketTester.class);
	 ...
	 * 
	 * @see SwarmWicketTester#clickLink(String, boolean)
	 * @param path

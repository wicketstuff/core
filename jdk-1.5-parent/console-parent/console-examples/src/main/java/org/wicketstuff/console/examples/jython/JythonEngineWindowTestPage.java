...
public class JythonEngineWindowTestPage extends ConsoleBasePage
{
	...
	private static final class OpenLink extends AjaxLink<Void>
	{
		...
		private OpenLink(final String id, final JythonScriptEngineWindow window)
		{
			super(id);
			this.window = window;
		}
	...
	public JythonEngineWindowTestPage(final PageParameters params)
	{
		super(params);

		add(window = new JythonScriptEngineWindow("window"));

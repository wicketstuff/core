...
/**
 * This page shows an example about using a {@link PrivateService service} that
 * does not have a public constructor. Dynamic proxies and
 * <code>&#64;{@link SpringBean}</code> does not work with these kind of classes
 * but {@link SpringReference} does.
 * 
 * This page is accessible from the home page trough a link.
 * 
 * Subclasses must implement {@link #getPrivateService()} used to get the
 * service.
 * 

...
public class LibraryData {
	...
	static {
		...
		// Local
		Library.register(Library.JQUERY, LocalProvider.DEFAULT,
				new int[][] { { 1, 0, 4 }, { 1, 1, 4 }, { 1, 2 }, { 1, 2, 1 },
						{ 1, 2, 2 }, { 1, 2, 3 }, { 1, 2, 4 }, { 1, 2, 5 },
						{ 1, 2, 6 }, { 1, 3 }, { 1, 3, 1 }, { 1, 3, 2 },
						{ 1, 4, 0 }, { 1, 4, 1 }, { 1, 4, 2 } });
		Library.register(Library.JQUERY_UI, LocalProvider.DEFAULT, new int[][] {
				{ 1, 5, 2 }, { 1, 5, 3 }, { 1, 7, 0 }, { 1, 7, 1 },
				{ 1, 7, 2 }, { 1, 8, 0 }, { 1, 8, 1 } });
		...
		Library.register(Library.SWFOBJECT, LocalProvider.DEFAULT, new int[][] {
				{ 2, 1 }, { 2, 2 }, });
		Library.register(Library.EXT_CORE, LocalProvider.DEFAULT,
				new int[][] { { 3, 0, 0 }, });

		// Google CDN
		Library.register(Library.JQUERY, CDN.GOOGLE, new int[][] { { 1, 2, 3 },
				{ 1, 2, 6 }, { 1, 3, 0 }, { 1, 3, 1 }, { 1, 3, 2 },
				{ 1, 4, 0 }, { 1, 4, 1 }, { 1, 4, 2 } });
		...
		Library.register(Library.PROTOTYPE, CDN.GOOGLE, new int[][] {
				{ 1, 6, 0, 2 }, { 1, 6, 0, 3 }, { 1, 6, 1 }, { 1, 7 }, });
		Library.register(Library.SCRIPTACULOUS, CDN.GOOGLE, new int[][] {
				{ 1, 8, 1 }, { 1, 8, 2 }, });
		Library.register(Library.YUI, CDN.GOOGLE, new int[][] { { 2, 6, 0 },
				{ 2, 7, 0 }, });
		Library.register(Library.DOJO, CDN.GOOGLE, new int[][] { { 1, 1, 1 },
				{ 1, 2, 0 }, { 1, 2, 3 }, { 1, 3, 0 }, { 1, 3, 1 }, });
		Library.register(Library.SWFOBJECT, CDN.GOOGLE, new int[][] { { 2, 1 },
				{ 2, 2 }, });
		Library.register(Library.EXT_CORE, CDN.GOOGLE,
				new int[][] { { 3, 0, 0 }, });
		// Yahoo CDN
		Library.register(Library.YUI, CDN.YAHOO, new int[][] { { 2, 6, 0 },
				{ 2, 7, 0 }, });

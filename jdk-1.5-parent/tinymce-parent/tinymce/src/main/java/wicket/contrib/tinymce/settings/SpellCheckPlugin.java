...
/**
 * This plugin adds spellchecker functionality to TinyMCE by providing a new
 * button that performs an AJAX call to a backend wicket resource. The spell
 * checking is performed by the Jazzy spellchecker <a

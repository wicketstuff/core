 ...
 * 
 * 
 * However for some cases you don't need the spatial definition but want to know values for certain non spatial columns.  
 * 
...
public class GetSpecificFeature extends AbstractControl {
	...
	/**
	 * @param layer the wms layer that is used to provide the bounding box.
	 * @param featureSelectionBehaviour this behaviour will be invoked with an &propertyValue parameter containing the value retrieved through WFS.
	 * @param proxyURL the full url including the ?url= if a proxy is being used.
	 * @param the wfs url
	 * @param featureTypeName the name of the feature to be queried.
	...
	/* (non-Javadoc)
	 * @see org.wicketstuff.openlayers.api.control.AbstractControl#getJSadd(org.wicketstuff.openlayers.IOpenLayersMap)
	 */
	@Override

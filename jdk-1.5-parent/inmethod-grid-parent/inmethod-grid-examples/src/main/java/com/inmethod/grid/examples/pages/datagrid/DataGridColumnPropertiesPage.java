...
public class DataGridColumnPropertiesPage extends BaseExamplePage
{
	...
	public DataGridColumnPropertiesPage()
	{
		...
		columns.add(new PropertyColumn(new ResourceModel("id"), "id").setInitialSize(3)
			.setSizeUnit(SizeUnit.EM)
			.setResizable(false)
			.setReorderable(false)
			.setHeaderTooltipModel(new Model("Person Id")));

		columns.add(new PropertyColumn(new ResourceModel("firstName"), "firstName", "firstName").setReorderable(
			false)
			.setInitialSize(200)
			.setMinSize(100)
			.setMaxSize(250)
		...
		columns.add(new PropertyColumn(new ResourceModel("cellPhone"), "cellPhone").setInitialSize(
			10)
			.setSizeUnit(SizeUnit.EM)
			.setResizable(false));

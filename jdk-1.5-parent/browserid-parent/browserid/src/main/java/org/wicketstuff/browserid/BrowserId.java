...
public class BrowserId implements Serializable {
    ...
    /**
     * Create {@link BrowserId} object from success or failure JSON
     * response
     *
     * @param json
     *      the response returned by https://browserid.org
     * @return a {@link BrowserId} instance with status OK if the authentication passed, or
     *  with status FAIL if the authentication failed, or {@code null} if the passed

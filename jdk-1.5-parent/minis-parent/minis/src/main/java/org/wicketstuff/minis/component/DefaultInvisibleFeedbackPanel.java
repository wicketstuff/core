...
/**
 * <p>
 * A simple {@link FeedbackPanel} variant which is only visible if there are
 * messages attached to it.
 * </p>
 *
 * <p>
 * Useful if your designer is putting always visible elements (like border, sign
 * image) on your feedback panels.
 * </p>
 *
 * @author akiraly
 */

...
public class HomePage extends ModalXPage implements IWindowCloseListener
{
		...
		add(new AjaxLink<Void>("showAnswerForm")
		{
			public void onClick(AjaxRequestTarget target)
			{
				...
				(
					...
					"ModalX ModalResult Feature",
					400,
					200,
					true,
					MessageBox.MB_YES_NO_CANCEL,
					HomePage.this
				);
			}
		});
	...
	/*
	 * Implement IWindowCloseListener to create a listener that can be notified
	 * when a ModalFormPanel (including MessageBox) is closed. Pass the listener
	 * into the constructor of the ModelFormPanel or MessageBox
	 */

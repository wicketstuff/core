...
public class TestForm extends ModalFormPanel
{
	 ...
	 */
	public TestForm(ModalContentWindow iModalContentWindow, IWindowCloseListener iWindowCloseListener, Person iPerson)
	{
	...
	{
		form.add(new RequiredTextField<String>("firstName", new PropertyModel<String>(person, "firstName")).setLabel(Model.of("First Name")));
		form.add(new RequiredTextField<String>("lastName", new PropertyModel<String>(person, "lastName")).setLabel(Model.of("Last Name")));
		form.add(new RequiredTextField<String>("address1", new PropertyModel<String>(person, "address1")).setLabel(Model.of("Address line 1")));
		form.add(new RequiredTextField<String>("address2", new PropertyModel<String>(person, "address2")).setLabel(Model.of("Address line 2")));
		form.add(new RequiredTextField<String>("state", new PropertyModel<String>(person, "state")).setLabel(Model.of("State")));
		form.add(new RequiredTextField<String>("country", new PropertyModel<String>(person, "country")).setLabel(Model.of("Country")));
		...
		form.add(new AjaxLink<Void>("showFormDefSource")
		{
			public void onClick(AjaxRequestTarget target)
			{
				...
				(
					...
					"}"+
					"</pre>\n",
					"Defining a ModalX Form class is easy!",
					840, 400
				);
			}
		});

 ...
 * Type       : concrete
 * Implements a simple way to communicate messages to users via a modal message box.
 * It is designed to be used by calling the static show methods, not via the constructor
 * directly.
 * 
...
/**
 * The default width of all MessageBoxS. Changed the default width of all MessageBoxS
 * by calling setDefaultWidth.
 */

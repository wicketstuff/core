...
/**
 * Class Name : ModalContentWindow Diagram : Wicket Generic Modal Windows
 * Project : Echobase framework Type : concrete Specialized form of ModalWindow
 * that knows how to interact with ModelContentPanels in a way which simplifies
 * the code that opens a modal window.
 * 
 * @author Chris Colman
 */

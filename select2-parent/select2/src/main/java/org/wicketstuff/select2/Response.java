...
public class Response<T> implements Iterable<T>
{
	...
	/**
	 * Sets the results collection. Collection can also be incrementally built using
	 * {@link #add(Object)} and {@link #addAll(Collection)} methods.
	 * 
	 * @param results
	...
	/**
	 * @return the {@code mode} flag used to tell Select2 whether or not there are more results
	 *         available.
	 */
	...
	/**
	 * Sets the {@code more} flag used to tell Select2 whether or not there are more results
	 * available.
	 * 
	 * @param more
	 *            more flag

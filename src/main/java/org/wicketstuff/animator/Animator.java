...
public class Animator implements Serializable
{
	 ...
	 * @return this {@link Animator}
	 */
	public Animator withADSRTransition(double attackEnd, double decayEnd, double suspendEnd,
			double sustainLevel)
	{
		return withTransition(String.format("Animator.makeADSR(%f, %f, %f, %f)", attackEnd,

...
public abstract class Dialog extends Panel implements IHeaderContributor {
    ...
    public Dialog(String id, IModel model, DialogSettings settings) {
        ...
        add(TextTemplateHeaderContributor.forJavaScript(Dialog.class,
    ...
    /**
     * return a model used to display the title
     * Should be overwrite in order to set a title
     ...
     * @param panelId id of the panel to return

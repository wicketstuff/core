...
( function() {
	...
	Wicket.yui.DDList = function(id, sGroup, config, callbackWicket) {

		Wicket.yui.DDList.superclass.constructor.call(this, id, sGroup, config);
	...
	YAHOO.extend(Wicket.yui.DDList, YAHOO.util.DDProxy, {

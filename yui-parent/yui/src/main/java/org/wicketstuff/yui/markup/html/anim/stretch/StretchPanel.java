...
public abstract class StretchPanel extends Panel
{
	...
	private String easing = YuiEasingConstants.EASE_OUT;
	...
	public void renderHead(HtmlHeaderContainer container)
	{
		...
		asb.append("}\n");
		asb.append("var anim = new YAHOO.util.Anim(this, att, " + delay + ", YAHOO.util.Easing." + easing + ");\n");
		...
		asb.append("var anim = new YAHOO.util.Anim(slide, att, " + delay + ", YAHOO.util.Easing." + easing + ");\n");
		asb.append("anim.animate();\n");
	...
	/**
	 * Set the delay in seconds, the time to collapse or expand completely. (default 1s)
	 * @param delay
	 */
	...
	/**
	 * Set the default state, one of {@link StretchPanel#EXPANDED} or {@link StretchPanel#COLLAPSED}  
	 * @param defaultState
	 */

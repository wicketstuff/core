 ...
 */
package org.wicketstuff.datetime.examples.dates;
...
import org.wicketstuff.datetime.examples.bean.validation.BeanValidationPage;
...
public class DatesPage extends WebPage
{
	...
	public DatesPage()
	{
		add(new Link<Void>("beanValidationPage")
		{
			private static final long serialVersionUID = 1L;
			...
			public void onClick()
			{
				setResponsePage(BeanValidationPage.class);
			}
		});

...
//**********************************************************************************************************************
    ...
    public <T> T lookupPlugin(Class<T> pluginType)
    {
        ...
        if (plugins == null)
        {
            throw new WicketRuntimeException("Plugin of type " + pluginType.getName() + " not found.");
        }
        if (plugins.size() == 1)
        {
            return plugins.get(0);
        }
        throw new WicketRuntimeException("There are " + plugins.size() + " plugins registered of type " + pluginType.getName() + ".");
    }
